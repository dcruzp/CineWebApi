...
namespace CineWebApi.Migrations
{
    ...
    [Migration("20210615213335_Compras_Asientos")]
    partial class Compras_Asientos
    {
            ...
            modelBuilder.Entity("CineWebApi.DBModels.Compra", b =>
                {
                    ...
                    b.Property<Guid?>("IdAsientoNavigationIdAsiento")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("IdAsientoNavigationIdAsiento");
            ...
            modelBuilder.Entity("CineWebApi.DBModels.Compra", b =>
                {
                    b.HasOne("CineWebApi.DBModels.Asiento", "IdAsientoNavigation")
                        .WithMany()
                        .HasForeignKey("IdAsientoNavigationIdAsiento");
